...
def run_sweep(project_name="inaturalist_cnn_partA"):
    """
    Run the sweep
    This addresses Question 2: Using the sweep feature in wandb
    """
    # Initialize wandb - replace with your API key or use wandb login in terminal
    wandb.login()
...
def main():
    ...
    # If you want to run hyperparameter sweep
    should_sweep = True
    
    if should_sweep:
        # Run hyperparameter sweep
        print("Starting hyperparameter sweep...")
        sweep_id = run_sweep(project_name="inaturalist_cnn_partA")
